...
class FacilityCards extends StatelessWidget {
  final tittle;
  final thumbnail;
  final ontap;

  FacilityCards({required this.thumbnail,required this.tittle, required this.ontap});
                      ...
                      child:SizedBox(
                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                                flex: 4,
                                child: Text(tittle,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),)),
                          ],
                        ),
